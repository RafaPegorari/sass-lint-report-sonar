...
ReporterModel.prototype.openReporter = function(projectName, projectType, baseProject, setFilePath) {
    baseProject = baseProject || '.';
    projectType = projectType || 'SCSS';
    baseFilePath = setFilePath || null; // Sonar bug

    var normalizedBaseProject = (os.platform() === 'win32' || os.platform() === 'win64') ? baseProject.replace(/\\/g, '\\\\') : baseProject;

    fs.writeFileSync(this.reportFile, '{\n' +
        '"language" : "' + projectType + '",\n' +
        '"project" : "' + projectName + '",\n' +
        '"projectPath" : "' + normalizedBaseProject + '",\n' +
        '"version" : "' + version + '",\n' +
        '"files" : [');
};
